...
{
  printf ("-> chay ham test_alarm_single\t line 18 alarm-wait.c\n");
  test_sleep (5, 1);
  printf ("-> ket thuc ham test_alarm_single\n");
}
...
{
  printf ("-> chay ham test_sleep\t line 53 alarm-wait.c\n");
  ...
  free (output);
  free (threads);
  printf ("-> ket thuc ham test_sleep\n");
}
